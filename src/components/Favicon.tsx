...
export const SystemFavicon: React.FC<{ system: OpenSourceSystemType, focus_mode?: boolean, mini_mode?: boolean, className?: string }> = ({ system, focus_mode, mini_mode, className }) => {
